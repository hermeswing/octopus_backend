...
public class TCodeDDto {
    ...
    public static TCodeDDto getDto(TCodeD code) {
        return TCodeDDto.builder().pCd(code.getPCd()).cd(code.getCd()).cdNm(code.getCdNm()).sortSeq(code.getSortSeq()).useYn(code.getUseYn())
    ...
    public TCodeD toEntity() {
        return TCodeD.builder().pCd(pCd).cd(cd).cdNm(cdNm).useYn(useYn).sortSeq(sortSeq).wdOpt1(wdOpt1).wdOpt2(wdOpt2).wdOpt3(wdOpt3)
