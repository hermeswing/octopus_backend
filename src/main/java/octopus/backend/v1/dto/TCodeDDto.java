...
public class TCodeDDto extends BaseDto {
    ...
    public static TCodeDDto makeDto(TCodeD code) {
        return TCodeDDto.builder().pCd(code.getPCd()).cd(code.getCd()).cdNm(code.getCdNm())
                ...
                .useYn(code.getUseYn()).wdOpt1(code.getWdOpt1()).wdOpt2(code.getWdOpt2())
                .wdOpt3(code.getWdOpt3())
                .wdOpt4(code.getWdOpt4()).wdOpt5(code.getWdOpt5()).numOpt1(code.getNumOpt1())
                .numOpt2(code.getNumOpt2())
                .numOpt3(code.getNumOpt3()).numOpt4(code.getNumOpt4()).numOpt5(code.getNumOpt5())
                .rmk(code.getRmk())
                .build();
    }
    ...
    public TCodeD toEntity() {
        return TCodeD.builder().pCd(pCd).cd(cd).cdNm(cdNm).useYn(useYn).sortSeq(sortSeq)
                .wdOpt1(wdOpt1).wdOpt2(wdOpt2)
                .wdOpt3(wdOpt3).wdOpt4(wdOpt4).wdOpt5(wdOpt5).numOpt1(numOpt1).numOpt2(numOpt2)
                .numOpt3(numOpt3)
                .numOpt4(numOpt4).numOpt5(numOpt5).rmk(rmk).crtId(getCrtId()).mdfId(getMdfId())
                .build();
    }
}
